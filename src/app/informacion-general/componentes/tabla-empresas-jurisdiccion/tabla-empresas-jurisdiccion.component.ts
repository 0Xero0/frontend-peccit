...
export class TablaEmpresasJurisdiccionComponent {
  ...
  constructor(
    ...
    this.formulario = new FormGroup<{
      ...
      capacidadTransportadoraA: new FormControl<string>("", [Validators.required]),
      capacidadTransportadoraB: new FormControl<string>("", [Validators.required]),
      capacidadTransportadoraC: new FormControl<string>("", [Validators.required]),
